...
"""
def execute_parallel_decomposition(folderpath, min_area, max_area, opt, bridge_thresholds, cores=10):
    files = get_files_from_folder(folderpath)
                ...
                if e is None:
                    ...
                    if result[0]:
                        if result[1] not in saved:
                            ...
                            decomposition_to_txt(result, folderpath)
                            #save_decomposition_info(result, folderpath)
                            #plot_decomposition(result, folderpath)
                    else:
...
if __name__ == '__main__':
    ...
    folder_input = input("input folderpath:")
    folderpath = folder_input+"\\*.mat"
    ...
    result = execute_parallel_decomposition(folderpath, min_area, max_area, opt, bridges_thresholds)
